...
public void save(SensorDataDTO sensorDataDTO) {
    ...
    try {
        ...
        sensorData.setTemperature((float) sensorDataDTO.getTemperature());
        sensorData.setHumidity((float) sensorDataDTO.getHumidity());
        sensorData.setsoil_moisture((float) sensorDataDTO.getsoil_moisture());
